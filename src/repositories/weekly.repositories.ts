...
export const newWeeklyChallenge = async(data: WeeklyChallengeCreation): Promise<Challenge | null> => {
    ...
    const newDate = await prisma.dateChallenge.create({
        data: {
...
export const getWeekly = async(data: bigint): Promise<DateChallenge | null> => {
