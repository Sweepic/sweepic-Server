...
import { handleUpdateChallenge, handleRemoveChallenge, handleAcceptChallenge, handleCompleteChallenge, handleGetByUserId, naverController } from '../controllers/challenge.controllers.js';
...
challengeRouter.get('/getGeocode', naverController);