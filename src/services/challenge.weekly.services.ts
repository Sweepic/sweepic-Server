...
import {
  getWeekly,
  newWeeklyChallenge,
} from '../repositories/weekly.repositories.js';
import {
  responseFromChallenge,
...
import {
  DateChallengeCreationError,
  DateChallengeNotFoundError,
} from '../errors.js';

export const serviceCreateNewWeeklyChallenge = async (
  ...
  try {
    ...
    if (newChallenge === null) {
      throw new DateChallengeCreationError({
